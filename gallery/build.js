...
const EXPECTED_NEEDS = {
  ...
  'HS-06': ['safety', 'transparency', 'trust'],
  'HS-07': ['safety', 'autonomy', 'trust'],
  'HS-08': ['safety', 'autonomy', 'transparency'],
  'HS-09': ['autonomy', 'fairness', 'trust'],
  'HS-10': ['autonomy', 'fairness', 'safety'],
  'HS-11': ['fairness', 'trust', 'transparency'],
