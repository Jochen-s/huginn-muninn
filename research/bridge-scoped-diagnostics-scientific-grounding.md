...
- **McGuire 1964** introduced inoculation theory: exposing readers to a weakened form of a persuasive attack builds cognitive resistance in the same way a vaccine builds immunological resistance. The analogy is load-bearing: the reader is not told the conclusion; they are shown the mechanism.
...
- **Roozenbeek & van der Linden 2019, 2022** demonstrated that gamified technique-naming (the "Bad News" and "Go Viral!" interventions) produces durable resistance to misinformation techniques and generalises across topics. The critical finding for PR 3: the durability is in technique-recognition, not in topic-specific correction.
...
- **Common Humanity psychology** (Oveis, Horberg, Keltner 2010; Tiwari & Elmufti 2024 on Common Humanity scale development) treats the perception of shared human experience as a trainable cognitive filter. The construct literature reports durable effects in some interventions and mixed cross-cultural psychometric properties; PR 3 does not claim it predicts misinformation-correction success.
...
- **Kappes, Harvey, Lohrenz, Montague, Sharot 2020** show that shared-reality perception modulates receptive updating in disagreement contexts. This is a mechanistic building block, not a misinformation-correction outcome measure.
...
- Briggs, J., Danyk, Y., & Weiss, R. (2026). The Gorgon Trap: structural taxonomy of cognitive-warfare signatures. Zenodo DOI 10.5281/zenodo.19326432.
